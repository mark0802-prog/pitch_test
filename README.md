...
登録しなくてもアプリは使用できます。正答率などのスコアを保存したい場合は、ユーザ登録をおこなってください。<br>
![demo](./apps/assets/gif/7c631e48807c2f978c33c62404f212ef.gif)

- ログイン
トップページの「ログイン」から、ログインをすることができます。<br>
ログインに成功すると、トップページにあなたのニックネームが表示されます。<br>
現状、パスワードの再発行機能はありません。忘れないようにご注意ください。<br>
![demo](./apps/assets/gif/b93748c67060be65b06aaa92026de0bc.gif)

- ランキングの確認
トップページから各種ランキングを確認することができます。<br>
ログインしている場合は、あなたの順位が赤字で表示されます。<br>
![demo](./apps/assets/gif/62102f35504392277944e197e0d657bf.gif)
...
**＊＊記録の更新は、選択肢のボタンを押したタイミングで実行されます＊＊**<br>
![demo](./apps/assets/gif/0f8fa6b22736f16500877fb35301938d.gif)
